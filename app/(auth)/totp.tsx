              ...
              <>
                ...
                {showFreshCodeHint && (
                  <Text className="text-center text-sm text-night-steel-muted">
                    Este código puede ser el mismo que usaste hace instantes (para confirmar tu
                    registro o para un login anterior) — esperá a que tu app de autenticación genere
